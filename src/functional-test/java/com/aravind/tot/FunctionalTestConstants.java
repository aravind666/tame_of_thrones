...
public class FunctionalTestConstants {
  private static final Path  resources = Paths.get("src","functional-test","resources");
  ...
  public static final String BAD_INPUT = RESOURCES_PATH + PATH_SEPARATOR + "input2.txt";
